...
from telas.inicial import criar_tela_inicial
from telas.cadastro import criar_tela_cadastro
from telas.login import criar_tela_login
from telas.overview_lider import criar_overview_lider
...
def esconder_todas_as_telas():
    ...
    frame_tela_cadastro.pack_forget()
    frame_tela_login.pack_forget()
    frame_tela_lider.pack_forget()
...
frame_tela_login = criar_tela_login(app, mostrar_tela_inicial, mostrar_tela_lider, mostrar_tela_cientista, mostrar_tela_comandante, mostrar_tela_oficial)
frame_tela_lider = criar_overview_lider(app, mostrar_tela_inicial)
frame_tela_cientista = criar_overview_cientista(app, mostrar_tela_inicial)
frame_tela_comandante = criar_overview_comandante(app, mostrar_tela_inicial)
frame_tela_oficial = criar_overview_oficial(app, mostrar_tela_inicial)
