...
def mostrar_tela_cientista(usuario, faccao):
    esconder_todas_as_telas()
    frame_tela_cientista = criar_overview_cientista(app, mostrar_tela_login, usuario, faccao)
    frame_tela_cientista.pack(pady=20)

# Função para mostrar a tela de comandante
def mostrar_tela_comandante(usuario, faccao):
    esconder_todas_as_telas()
    frame_tela_comandante = criar_overview_comandante(app, mostrar_tela_login, usuario, faccao)
    frame_tela_comandante.pack(pady=20)

# Função para mostrar a tela de oficial
def mostrar_tela_oficial(usuario, faccao):
    esconder_todas_as_telas()
    frame_tela_oficial = criar_overview_oficial(app, mostrar_tela_login, usuario, faccao)
...
app.geometry("1600x900")  # Aumenta o tamanho da janela principal
