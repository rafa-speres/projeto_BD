...
BEGIN
    ...
    EXCEPTION
        WHEN NO_DATA_FOUND THEN
            RAISE_APPLICATION_ERROR(-20002, 'A comunidade n�o pertence a um planeta possivel.');
        WHEN OTHERS THEN
...
-- Criando um Tipo para exibir o relat�rio do OFICIAL
...
-- Criando um Tipo para a tabela de registros que ser� utilizada para exibir o relat�rio do OFICIAL
CREATE OR REPLACE TYPE tp_relatorio_tabela_oficial AS TABLE OF tp_relatorio_oficial;

-- Cria��o do pacote do OFICIAL
...
CREATE OR REPLACE PACKAGE BODY pkg_oficial AS
    ...
    BEGIN
        ...
        IF v_nacao_nome IS NOT NULL THEN
            -- Caso DEFAULT: informa��es sobre as comunidades da NACAO do LIDER
...
CREATE OR REPLACE PACKAGE BODY pkg_comandante AS
    ...
    BEGIN
        ...
        -- Verificar se a na��o inserida e a mesma do lider logado
        IF v_nacao = p_nacao THEN
            ...
            END IF;
        ELSE
            DBMS_OUTPUT.PUT_LINE('Erro: Voc� s� pode modificar a sua propria na��o.');
        END IF;
    ...
    EXCEPTION
        ...
        WHEN OTHERS THEN
            DBMS_OUTPUT.PUT_LINE('Erro ao incluir na��o em federacao: ' || SQLERRM);
            RAISE;
    ...
    EXCEPTION
        WHEN NO_DATA_FOUND THEN
            DBMS_OUTPUT.PUT_LINE('Nacao ou federacao nao encontrada.');
        WHEN OTHERS THEN
            DBMS_OUTPUT.PUT_LINE('Erro ao excluir na��o de federa�ao: ' || SQLERRM);
            RAISE;
    ...
    BEGIN
        ...
        IF v_nacao = p_nacao THEN
            ...
            WHERE NOME = v_nacao;
            COMMIT;
            DBMS_OUTPUT.PUT_LINE('Federa��o ' || p_federacao || ' criada com a na��o ' || v_nacao);
        ELSE
            DBMS_OUTPUT.PUT_LINE('Erro: Voc� s� pode criar federa��o com a sua pr�pria na��o.');
        END IF;
